...
仅支持1.9.3版本本体，必须用简中、英文或葡萄牙语进行游戏
暂不支持单独开关卡牌
...
待优化
 -观察弱点意图不为攻击时的文本 参考交锋文本实现
 -哨位在在使用点烧时高亮 通过奇巧/selectexhua定位高亮
 -灼热打击震动火焰特效随等级增强
 -死亡收割新vfx调用鲜血药水特效，闪电球激发音效/根据敌人多次播放
 -尸爆动画延迟 尸爆power图标重新裁取
